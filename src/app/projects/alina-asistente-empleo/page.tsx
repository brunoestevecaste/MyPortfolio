    ...
    <main id="main-content" tabIndex={-1} className="site-container flex-1">
      <article>
        <header className={styles.caseHeader}>
          ...
          <h1 className={styles.caseTitle}>{alinaProject.title}</h1>
          <p className={styles.caseLead}>{alinaCase.introduction}</p>
        </header>

        <dl className={styles.facts}>
          <div>
            <dt>Organización</dt>
            <dd>{alinaProject.organization}</dd>
          </div>
          <div>
            <dt>Mi aportación</dt>
            <dd>{alinaProject.role}</dd>
          </div>
          <div>
            ...
            <dd>
              ...
              <br />
              Máster en IA / Feb – Mar {alinaProject.year}
            </dd>
          </div>
          <div>
            <dt>Alcance</dt>
            <dd>Prototipo funcional (FastAPI + Google ADK + React)</dd>
          </div>
        </dl>
